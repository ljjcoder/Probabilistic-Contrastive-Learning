...
import os
import sys
sys.path.append("./flexmatch_package/")
import logging
import random
import warnings
...
def main(args):
    ...
    '''
    args.num_split=1
    args.num_NCE_instance=112

    args.NCE_weight=0.001
    args.NCE_scale=7 
    if args.NCE_weight>0.0:    
        args.save_dir=args.save_dir+'_data2_test/'+'args.dataset_cifar/'+str(args.num_labels)+'/'+localtime+'NCE_split_'+str(args.num_split)+'_num_'+str(args.num_NCE_instance)+'_weight_'+str(args.NCE_weight)+'_scale_'+str(args.NCE_scale)+'_seed_'+str(args.seed)+'_normal'
    else:
        args.save_dir=args.save_dir+'_data2_test_orionlynormal_retest/'+'args.dataset_cifar/'+str(args.num_labels)+'/'+localtime+'NCE_split_'+str(args.num_split)+'_num_'+str(args.num_NCE_instance)+'_weight_'+str(args.NCE_weight)+'_scale_'+str(args.NCE_scale)+'_seed_'+str(args.seed)+'_normal'    
...
if __name__ == "__main__":
    ...
    '''
    parser.add_argument('--save_dir', type=str, default="/gdata2/lijj/Torch_ssl")
    ...
    parser.add_argument('--data_dir', type=str, default="/ghome/lijj/DA/TorchSSL-main/TorchSSL-main1/data")
